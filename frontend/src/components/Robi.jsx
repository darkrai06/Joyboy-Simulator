const Robi = () => {
  return (
    <div>
      <h1 className="text-3xl font-bold text-gray-800 mb-4">Robi</h1>
      <p className="text-gray-600 mb-6">Manage Robi services and data.</p>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white p-6 rounded-lg shadow">
          <h2 className="text-xl font-semibold text-gray-800">Active Users</h2>
          <p className="text-2xl font-bold text-green-600 mt-2">32,456</p>
          <p className="text-sm text-gray-500 mt-1">+15% from last month</p>
        </div>
        <div className="bg-white p-6 rounded-lg shadow">
          <h2 className="text-xl font-semibold text-gray-800">Revenue</h2>
          <p className="text-2xl font-bold text-blue-600 mt-2">$189,234</p>
        ...
        <div className="bg-white p-6 rounded-lg shadow">
          ...
          <p className="text-2xl font-bold text-purple-600 mt-2">987 GB</p>
        ...
        <div className="bg-white p-6 rounded-lg shadow">
          ...
          <p className="text-2xl font-bold text-red-600 mt-2">18</p>
